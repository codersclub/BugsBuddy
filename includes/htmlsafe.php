<?
	/*
	 * Make every 'Post', 'Get' and 'Cookie' value html safe. Be warned: $_SESSION does not becomes htmlsafe
	 */
	...
	/*
	 * Converts every charater in the string to a html-safe representation except for the characters: a-z, A-Z and 0-9
	...
	/*
	 * Strips slashes from a string example: "hello I\'m Alex" will become "hello I'm Alex" and "test\\this" becomes "test\this"
	 */
